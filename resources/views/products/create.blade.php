                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="description" name="description" class="form-control" id="description" aria-describedby="description" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="weigth" name="weigth" class="form-control" id="weigth" aria-describedby="weigth" >
                        </div>
